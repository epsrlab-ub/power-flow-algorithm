# -*- coding: utf-8 -*-
"""
Created on Sun Oct  6 16:04:52 2024
...
from build_inexact_Jacobian import build_inexact_Jacobian

# Define the function for the backward_forward method for distribution network analysis. 
def icj_method(load_data, line_data, slack_bus_voltage=1, tolerance=1e-6, max_iter = 100, runs = 10):
